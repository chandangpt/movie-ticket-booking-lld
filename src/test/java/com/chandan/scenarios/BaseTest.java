package com.chandan.scenarios;

import com.chandan.api.*;
import com.chandan.provider.InMemorySeatLockProvider;
import com.chandan.services.*;
...
public class BaseTest {
    ...
    protected PaymentController paymentsController;
    ...
    protected void setupControllers(int lockTimeout, int allowedRetries) {
        ...
        paymentsController = new PaymentController(paymentsService, bookingService);
    }
